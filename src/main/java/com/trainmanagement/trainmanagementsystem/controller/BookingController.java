...
public class BookingController {
    ...
    @GetMapping("/complete")
    public String showBookingCompletion(Model model, HttpServletRequest request) {
        try {
            ...
            Long scheduleId = (Long) request.getSession().getAttribute("bookingScheduleId");
            String seatIds = (String) request.getSession().getAttribute("bookingSeatIds");
            
            if (bookingRequest == null || selectedSeats == null || scheduleId == null) {
            ...
            System.out.println("[DEBUG] BookingController GET - Principal type: " + (principal != null ? principal.getClass().getSimpleName() : "null"));
            System.out.println("[DEBUG] BookingController GET - Principal value: " + principal);
            ...
            if (principal instanceof String && !"anonymousUser".equals(principal)) {
                ...
                if (passenger != null) {
                    ...
                    System.out.println("[DEBUG] BookingController GET - Set passenger name: " + passenger.getFullName());
                } else {
                    ...
                    System.out.println("[DEBUG] BookingController GET - Set username as passenger name: " + username);
                }
            } else {
                ...
                System.out.println("[DEBUG] BookingController GET - Unknown principal type, setting passenger name to '-'");
            }
            ...
            if (!selectedSeats.isEmpty()) {
                ...
                for (Seat seat : selectedSeats) {
                    // Extract class type from coach number (A, B, or C)
                    String classType = seat.getCoachNum().substring(0, 1);
                    double seatPrice = pricingService.getPrice(fromStation, toStation, classType);
            ...
            System.out.println("[ERROR] BookingController GET - Error: " + e.getMessage());
            e.printStackTrace();
            model.addAttribute("error", "Error loading booking completion: " + e.getMessage());
            return "redirect:/trains/search";
        }
    }
    ...
    public String completeBooking(
        ...
        try {
            ...
            if (principal instanceof com.trainmanagement.trainmanagementsystem.entity.Passenger) {
                ...
                // Not logged in, store booking data in session and redirect to login
                System.out.println("[DEBUG] User not authenticated, storing booking data and redirecting to login");
                
                // Store booking data in session BEFORE redirecting to login
                ...
                request.getSession().setAttribute("bookingScheduleId", scheduleId);
                request.getSession().setAttribute("bookingSeatIds", seatIds);
